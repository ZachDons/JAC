function [ hrTable, timeT] = Schedule(time, visData)
...
perMoon = [0 0.33 0.33 0.33]; %Must add to 1
...
% Downlink counter
downCnt = 0; % Counter 
downMax = 6; % Number of science orbits before downlink
...
% charging
elseif SOC_Calc(7,soc) > 0.8 && downCnt ~= downMax && ~chargeMode 
